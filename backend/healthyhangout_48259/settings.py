"""
Django settings for healthyhangout_48259 project.
...
ROOT_URLCONF = 'healthyhangout_48259.urls'
...
WSGI_APPLICATION = 'healthyhangout_48259.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "healthyhangout_48259 API",
    "DESCRIPTION": "API documentation for healthyhangout_48259 App",
    "VERSION": "v1",
}
